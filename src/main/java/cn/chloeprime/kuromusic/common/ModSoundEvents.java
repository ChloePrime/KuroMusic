...
public class ModSoundEvents {
    ...
    public static final RegistryObject<SoundEvent> BACKGROUND_MUSIC = DFR.register("background_music", () -> SoundEvent.createFixedRangeEvent(KuroMusic.loc("background_music"), Integer.MAX_VALUE));
